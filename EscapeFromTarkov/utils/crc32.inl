...
// Precalculated crc lookup table. It's an eyesore but it's the price we have to pay
    // to not have initialization/inefficient & slow calculations.
