...
#include "../EscapeFromTarkov/utils/xorstr.hpp"
...
#define get_keycode_name(vk, name)\
switch (vk) {\
case VK_CONTROL: name = xorget("control"); break;\
case VK_SHIFT: name = xorget("shift"); break;\
case VK_LSHIFT: name = xorget("shift"); break;\
case VK_MENU: name = xorget("alt"); break;\
case VK_TAB: name = xorget("tab"); break;\
case VK_LBUTTON: name = xorget("Mouse 1"); break;\
case VK_RBUTTON: name = xorget("Mouse 2"); break;\
case VK_MBUTTON: name = xorget("Mouse 3"); break;\
case VK_XBUTTON1: name = xorget("Mouse 4"); break;\
case VK_XBUTTON2: name = xorget("Mouse 5"); break;\
case VK_PRIOR: name = xorget("page up"); break;\
case VK_NEXT: name = xorget("page down"); break;\
case VK_END: name = xorget("end"); break;\
case VK_HOME: name = xorget("home"); break;\
case VK_LEFT: name = xorget("left arrow"); break;\
case VK_UP: name = xorget("up arrow"); break;\
case VK_RIGHT: name = xorget("right arrow"); break;\
case VK_DOWN: name = xorget("down arrow"); break;\
case VK_INSERT: name = xorget("insert"); break;\
case VK_DELETE: name = xorget("delete"); break;\
case 'A': name = xorget("a"); break;\
case 'B': name = xorget("b"); break;\
case 'C': name = xorget("c"); break;\
case 'D': name = xorget("d"); break;\
case 'E': name = xorget("e"); break;\
case 'F': name = xorget("f"); break;\
case 'G': name = xorget("g"); break;\
case 'H': name = xorget("h"); break;\
case 'I': name = xorget("i"); break;\
case 'J': name = xorget("j"); break;\
case 'K': name = xorget("k"); break;\
case 'L': name = xorget("l"); break;\
case 'M': name = xorget("m"); break;\
case 'N': name = xorget("n"); break;\
case 'O': name = xorget("o"); break;\
case 'P': name = xorget("p"); break;\
case 'Q': name = xorget("q"); break;\
case 'R': name = xorget("r"); break;\
case 'S': name = xorget("s"); break;\
case 'T': name = xorget("t"); break;\
case 'U': name = xorget("u"); break;\
case 'V': name = xorget("v"); break;\
case 'W': name = xorget("w"); break;\
case 'X': name = xorget("x"); break;\
case 'Y': name = xorget("y"); break;\
case 'Z': name = xorget("z"); break;\
case VK_NUMPAD0: name = xorget("numpad 0"); break;\
case VK_NUMPAD1: name = xorget("numpad 1"); break;\
case VK_NUMPAD2: name = xorget("numpad 2"); break;\
case VK_NUMPAD3: name = xorget("numpad 3"); break;\
case VK_NUMPAD4: name = xorget("numpad 4"); break;\
case VK_NUMPAD5: name = xorget("numpad 5"); break;\
case VK_NUMPAD6: name = xorget("numpad 6"); break;\
case VK_NUMPAD7: name = xorget("numpad 7"); break;\
case VK_NUMPAD8: name = xorget("numpad 8"); break;\
case VK_NUMPAD9: name = xorget("numpad 9"); break;\
case VK_F1: name = xorget("F1"); break;\
case VK_F2: name = xorget("F2"); break;\
case VK_F3: name = xorget("F3"); break;\
case VK_F4: name = xorget("F4"); break;\
case VK_F5: name = xorget("F5"); break;\
case VK_F6: name = xorget("F6"); break;\
case VK_F7: name = xorget("F7"); break;\
case VK_F8: name = xorget("F8"); break;\
case VK_F9: name = xorget("F9"); break;\
case VK_F10: name = xorget("F10"); break;\
case VK_F11: name = xorget("F11"); break;\
case VK_F12: name = xorget("F12"); break;\
default: name = xorget("unknown");\
}
